...
**Ключевое достижение проекта:** Головоломки, сгенерированные "Гроссмейстером" (особенно высокой сложности 7x7 и 8x8), успешно выявляют пределы и ошибки в рассуждениях даже у state-of-the-art больших языковых моделей (LLM), таких как ChatGPT и Gemini. Эти модели, столкнувшись с задачами, требующими тысяч "ветвлений", либо уклоняются от решения и галлюцинируют, либо допускают фактические ошибки в своих логических выкладках.
