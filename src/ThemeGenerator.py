def generate_theme_prompt(theme_idea: str) -> str:
    ...
    2.  Придумай ровно 4 названия для категорий. Названия должны быть в единственном числе.
    3.  Для каждой из 4 категорий придумай ровно 8 уникальных, интересных и тематических названий/имен.
